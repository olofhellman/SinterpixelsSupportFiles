...
The icon design is by Tomographic's Senior Designer in Residence, Koji Hellman.  Here's how its rendered:

First we draw the background: four white squares and four white circles.  The circles are at the corners and create the curved shape of the corners.  The bits at the corners not covered by the circles stay transparent.

Then we make the red parallelogram, overlay the blue circle, and then overlay a red circle just to cover the inner portion of the p. Without that, a tiny sliver of the blue circle would show in the middle of the p.
